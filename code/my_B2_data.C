...
void  my_B2_data_gr(int col, TString onefile){
  ...
  //TString outfile		= dir + base + TString("_mul.ps");
  //TString outfileO	= dir + base + TString("_mul.ps(");
  //TString outfileC	= dir + base + TString("_mul.ps]");
  ...
  */
  ...
  for (int ipart=0;ipart<3;ipart++){		// pi, then K, then p
    ...
    ghyKeptp_cent[ipart]        ->SetTitle(Form("Pref. %s+;CentralityBin",partname1[ipart]));
    ...
    ghyKeptm_cent[ipart]        ->SetTitle(Form("Pref. %s-;CentralityBin",partname1[ipart]));
    ...
    ghmultp_cent[ipart]        ->SetTitle(Form("Pref. %s+;CentralityBin",partname1[ipart]));
    ...
    ghmultm_cent[ipart]        ->SetTitle(Form("Pref. %s-;CentralityBin",partname1[ipart]));
...
void my_B2_data(int ds=16){
  //my_B2_data_gr(0,Form("root_files_04122022/reader_c100_data_%d_cuts1_W1.root",ds));
  
  for(int i=1;i<17;i++){
    my_B2_data_gr(0,Form("root_files/reader_c100_data_%d_cuts%d_W1.root",ds,i));
  }
  /*
  my_B2_data_gr(0,Form("root_files/reader_m40_data_%d_cuts1_xs.root",ds));
  my_B2_data_gr(0,Form("root_files/reader_m40_data_%d_cuts1_W1_xp.root",ds));
  my_B2_data_gr(0,Form("root_files/reader_m40_data_%d_cuts1_W1_xs.root",ds));
  my_B2_data_gr(0,Form("root_files/reader_m40_data_%d_cuts1_W1minv_xp.root",ds));
  my_B2_data_gr(0,Form("root_files/reader_m40_data_%d_cuts1_W1minv_xs.root",ds));
  my_B2_data_gr(0,Form("root_files/reader_m40_data_%d_cuts1_W1minvqcut_xp.root",ds));
  my_B2_data_gr(0,Form("root_files/reader_m40_data_%d_cuts1_W1minvqcut_xs.root",ds));
  */
}
