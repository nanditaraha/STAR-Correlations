//Here we compare diff sim of B2 from R2 and sum rule
...
//
//--------------------------------------------------------------------------
void  my_B2_sim_gr(int col, TString onefile){
  ...
  int kCS			= 1;		// cuts set 
  bool SIMINPUT	= true;		// set to true if simulation input
  //--------------------------------------------
  ...
  TString base		= TString("B2_int") + ofstring;
...
void my_B2_int_sim(int ds=16){
  my_B2_sim_gr(0,Form("root_files/reader_c16_urqmdLN_%d_cuts1.root",ds));
  my_B2_sim_gr(1,Form("root_files/reader_c16_ampt_%d_cuts1.root",ds));
  my_B2_sim_gr(2,Form("root_files/reader_c16_hijing_%d_cuts1.root",ds));
